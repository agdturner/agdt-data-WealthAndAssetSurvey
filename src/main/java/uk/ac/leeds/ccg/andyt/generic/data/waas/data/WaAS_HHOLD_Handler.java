...
public class WaAS_HHOLD_Handler extends WaAS_Handler {
    ...
    public Object[] loadW5() {
        ...
        env.logStartTag(m);
        Object[] r;
        File cf = getSubsetCacheFile(W5, "InW4");
        if (cf.exists()) {
            r = (Object[]) load(W5, cf);
        } else {
            r = new Object[4];
    ...
    public Object[] loadW4(Set<Short> s, String type) {
        ...
        env.logStartTag(m);
        Object[] r;
        File cf = getSubsetCacheFile(W4, type);
        if (cf.exists()) {
            r = (Object[]) load(W4, cf);
        } else {
            r = new Object[4];
    ...
    public Object[] loadW4() {
        ...
        env.logStartTag(m);
        Object[] r;
        File cf = getSubsetCacheFile(W4, "InW3");
        if (cf.exists()) {
            r = (Object[]) load(W4, cf);
        } else {
            r = new Object[4];
    ...
    public Object[] loadW3() {
        ...
        env.logStartTag(m);
        Object[] r;
        File cf = getSubsetCacheFile(W3, "InW2");
        if (cf.exists()) {
            r = (Object[]) load(W3, cf);
        } else {
            r = new Object[4];
    ...
    public Object[] loadW3(Set<Short> s, String type) {
        ...
        env.logStartTag(m);
        Object[] r;
        File cf = getSubsetCacheFile(W3, type);
        if (cf.exists()) {
            r = (Object[]) load(W3, cf);
        } else {
            r = new Object[4];
    ...
    public Object[] loadW2() {
        ...
        env.logStartTag(m);
        Object[] r;
        File cf = getSubsetCacheFile(W2, "InW1");
        if (cf.exists()) {
            r = (Object[]) load(W2, cf);
        } else {
            r = new Object[4];
    ...
    public Object[] loadW2(Set<Short> s, String type) {
        ...
        env.logStartTag(m);
        Object[] r;
        File cf = getSubsetCacheFile(W2, type);
        if (cf.exists()) {
            r = (Object[]) load(W2, cf);
        } else {
            r = new Object[4];
    ...
    public Object[] loadW1(Set<Short> s, String type) {
        ...
        env.logStartTag(m);
        Object[] r;
        File cf = getSubsetCacheFile(W1, type);
        if (cf.exists()) {
            r = (Object[]) load(W1, cf);
        } else {
            r = new Object[2];
