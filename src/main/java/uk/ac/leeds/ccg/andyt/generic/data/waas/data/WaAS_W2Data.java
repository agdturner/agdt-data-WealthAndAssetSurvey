...
public class WaAS_W2Data implements Serializable {
     ...
     */
    public final TreeMap<WaAS_W2ID, WaAS_W2Record> lookup;
    /**
     * CASEW1 in Wave 2 records.
     */
    public final TreeSet<WaAS_W1ID> w1_In_w2;
    /**
     * All CASEW2 values.
     */
    public final TreeSet<WaAS_W2ID> all;
    /**
     * CASEW2 IDs for records that have CASEW1.
     */
    public final TreeSet<WaAS_W2ID> w2_In_w1;

    /**
     * Keys are CASEW2 and values are CASEW1.
     */
    public final TreeMap<WaAS_W2ID, WaAS_W1ID> w2_To_w1;

    /**
     * Keys are CASEW1 and values are sets of CASEW2 (normally size one).
     */
    public final TreeMap<WaAS_W1ID, HashSet<WaAS_W2ID>> w1_To_w2;
