...
public class WaAS_DataInAllWaves extends WaAS_Object {
    ...
    public Map<WaAS_W1ID, WaAS_W1Record> w1recs;
    //public Set<WaAS_ID2> w1IDs;
    public WaAS_W2Data w2Data;
    public Map<WaAS_W2ID, WaAS_W2Record> w2recs;
    //public Set<WaAS_ID2> w2IDs;
    public WaAS_W3Data w3Data;
    public Map<WaAS_W3ID, WaAS_W3Record> w3recs;
    //public Set<WaAS_ID2> w3IDs;
    public WaAS_W4Data w4Data;
    public Map<WaAS_W4ID, WaAS_W4Record> w4recs;
    //public Set<WaAS_ID2> w4IDs;
    public WaAS_W5Data w5Data;
    public Map<WaAS_W5ID, WaAS_W5Record> w5recs;
    //public Set<WaAS_ID2> w5IDs;

    /**
     * For storing a subset of the lookup.
     */
    public Map<WaAS_W1ID, Set<WaAS_W2ID>> w1_To_w2;
    /**
     * For storing a subset of the lookup.
     */
    public Map<WaAS_W2ID, WaAS_W1ID> w2_To_w1;
    /**
     * For storing a subset of the lookup.
     */
    public Map<WaAS_W2ID, Set<WaAS_W3ID>> w2_To_w3;
    /**
     * For storing a subset of the lookup.
     */
    public Map<WaAS_W3ID, WaAS_W2ID> w3_To_w2;
    /**
     * For storing a subset of the lookup.
     */
    public Map<WaAS_W3ID, Set<WaAS_W4ID>> w3_To_w4;
    /**
     * For storing a subset of the lookup.
     */
    public Map<WaAS_W4ID, WaAS_W3ID> w4_To_w3;
    /**
     * For storing a subset of the lookup.
     */
    public Map<WaAS_W4ID, Set<WaAS_W5ID>> w4_To_w5;
    /**
     * For storing a subset of the lookup.
     */
    public Map<WaAS_W5ID, WaAS_W4ID> w5_To_w4;
