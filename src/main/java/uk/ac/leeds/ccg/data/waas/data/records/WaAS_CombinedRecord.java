...
public class WaAS_CombinedRecord extends Data_Record {
     ...
     * Keys are CASEW2
     */
    public final Map<WaAS_W2ID, WaAS_W2Record> w2Recs;

    /**
     * Keys are CASEW2, values keys are CASEW3.
     */
    public final Map<WaAS_W2ID, Map<WaAS_W3ID, WaAS_W3Record>> w3Recs;

    /**
     * Keys are CASEW2, values keys are CASEW3, next value keys are CASEW4.
     */
    public final Map<WaAS_W2ID, Map<WaAS_W3ID, Map<WaAS_W4ID, WaAS_W4Record>>> w4Recs;

    /**
     * Keys are CASEW2, values keys are CASEW3, next value keys are CASEW4, next
     * value keys are CASEW5.
     */
    public final Map<WaAS_W2ID, Map<WaAS_W3ID, Map<WaAS_W4ID, Map<WaAS_W5ID, WaAS_W5Record>>>> w5Recs;
